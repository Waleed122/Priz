...
<title>Prize Banker - Thankyou</title>
...
<div id="main">
	<div id="main2">
    	...
    	<div id="header"></div>
        <div id="menu" style="background-position: 533px 0px">
			<ul>
        ...
        <div id="content">
            ...
            <?php
			if (has_Transaction(Protect($_GET['tx']))){
				echo "<div id='invite'>
                	<div class='title'>Error</div>
                    <div class='descrip'>
                    Duplicate Transaction ID or fake Transaction ID found.
                    </div>
                   </div>";
			}else{
				$transaction_id = Protect($_GET['tx']);
				include "sandbox.php";
			}
			?>
