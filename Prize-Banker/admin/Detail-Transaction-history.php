...
$TransactionDetails = new TransactionDetails($_GET['txn']);
?>
...
<div class="container" id="container">
    <div  id="header">
		...
		<div id="content_main" class="clearfix">
			...
			<div class="section">
			<h2 class="ico_mug">Details</h2>
				<table width="500" border="0" cellspacing="3" cellpadding="3">
  <tr>
    <td>First Name:</td>
    <td><?php echo $TransactionDetails->first_name; ?></td>
  </tr>
  <tr>
    <td>Last Name:</td>
    <td><?php echo $TransactionDetails->last_name; ?></td>
  </tr>
  <tr>
    <td>Email: </td>
  ...
  <tr>
    <td>Fund for Cause:</td>
    <td><?php echo $TransactionDetails->item_name; ?></td>
  </tr>
  <tr>
    <td>Fund:</td>
    <td>$<?php echo $TransactionDetails->amount; ?></td>
  </tr>
  <tr>
    <td>Transaction ID: </td>
    <td><?php echo $_GET['txn']; ?></td>
  </tr>
  <tr>
    <td>Country:</td>
    <td><?php echo $TransactionDetails->country; ?></td>
  </tr>
  <tr>
    <td>City:</td>
    <td><?php echo $TransactionDetails->city; ?></td>
  </tr>
  <tr>
    <td>State:</td>
    <td><?php echo $TransactionDetails->state; ?></td>
  </tr>
  <tr>
    <td>Street Address:</td>
    <td><?php echo $TransactionDetails->street_address; ?></td>
  </tr>
  <tr>
    <td>Zip:</td>
    <td><?php echo $TransactionDetails->zip; ?></td>
  </tr>
  <tr>
    <td>Date: </td>
    <td><?php echo $TransactionDetails->date1; ?></td>
  </tr>
              </table>
