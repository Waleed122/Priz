...
<div class="container" id="container">
    <div  id="header">
		...
		<div id="postedit" class="clearfix">
			...
			<h2 class="ico_mug">Send Mass Mail</h2>
			<form method="post" action="Send-Mass-Mail.php">
			<div><input id="post_title" name="subject" type="text" placeholder="Mail Subject" tabindex="1" style="width:600px; font-size:20px;" /></div>
			<div id="form_middle_cont" class="clearfix">
			<div class="left"><textarea id="markItUp" name="body" cols="80" rows="10" placeholder="Mail Body"></textarea></div>
			</div>
