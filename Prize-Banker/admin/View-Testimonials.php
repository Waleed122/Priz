...
if ($_GET['delete']){
	...
	$query = mysql_query("delete from testimonial where id='$id'") or die(mysql_error());
}

if ($_POST['delete']){
	$id = $_POST['delete'];
	$ids = Protect(implode(",",$id));
	$query = mysql_query("delete from testimonial where id in ($ids)") or die(mysql_error());
}
?>
    ...
    <div  id="header">
		...
		<table id="table">
			...
			while ($row = mysql_fetch_assoc($query)){
				...
				<td class='table_date'>$title</td>
				<td class='table_date'><a href='http://www.youtube.com/watch?v=$embed_code' target='_blank'>$embed_code</a></td>
