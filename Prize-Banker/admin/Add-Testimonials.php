...
if ($_POST['submit']){
	...
	$embed_code = mysql_real_escape_string(GetVideoID($_POST['embed_code']));
	$query = mysql_query("insert into testimonial VALUES('','$title','$embed_code')") or die(mysql_error());
}
    ...
    <div  id="header">
		...
		<form method="post">
			<fieldset>
		  	  ...
		  	  <label>Title: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="title" placeholder="Add Title" size="60" /></label> 
              <label>Video URL: <input type="text" name="embed_code" placeholder="Video URL" size="60" /></label>
			  <br /> <input type="submit" name="submit" value="Save" /> | <input type="button" value="Cancel" onclick="javascript:window.location = 'manage-causes.php'" />
 		</fieldset>
		</form>
		</p>
        </div>
