    ...
    <div  id="header">
        ...
        <?php
			if ($_POST['submit']){
				...
				echo LeftPanelUpdate($title,$description,"1");
			}
			...
			$Panels = new Panels("1");
			?>
			<h2 class="ico_mug">Edit Left Panel</h2>
			<form method="post">
			...
			<div class="left"><textarea id="markItUp" name="description" cols="80" rows="10"><?php echo $Panels->description; ?></textarea></div>
			</div>
