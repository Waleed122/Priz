...
$query = mysql_query("select * from causes where id='$id'") or die(mysql_error());
...
if ($_POST['submit']){
	...
	$query = mysql_query("update causes set title='$add_causes' where id='$id'") or die(mysql_error());
	header("Location: manage-causes.php");
}
    ...
    <div  id="header">
		...
		<form method="post">
			<fieldset>
		  	  ...
		  	  <label>Edit Causes: <input type="text" name="add_causes" placeholder="Add Cause" size="60" value="<?php echo $title; ?>" /></label> 
